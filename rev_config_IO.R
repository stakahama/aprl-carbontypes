...
FilePath <- function(f) {
  filelist <- c(
    ...
    ## -----------------------------------------------------------------------------
    "mcmmass"="inputs/^mcm_(.+)_mass\\.txt$",
    "simpol"="rev_data/merged_SIMPOLgroups.csv",
    "fulltable"="rev_data/merged_MCMGroups_atomfulltable.csv",
    "adjacent"="rev_data/merged_adjacent_atoms.csv",
    "carbonattr"="rev_data/merged_C_attributes.csv",
    "groupattr"="rev_data/merged_group_attributes.csv",
    "molecattr"="rev_data/merged_molec_attributes.csv",
    "matrices"="rev_data/merged_matrices.rda",
    "matrices_2"="rev_data/merged_matrices_2.rda",
    ## -----------------------------------------------------------------------------
